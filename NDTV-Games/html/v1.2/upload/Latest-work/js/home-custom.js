$(document).ready(function () {
  ...
  $('.log, .side-nv-log-trigger, .side-nav-trigger, .search-trigger, .drp-trigger, .match-trigger, .lst-trg').on('click', function () {
